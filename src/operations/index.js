...
const __TEMPLATES = require('./templates');
const __ACCOUNTING = require('./accounting');
const __INVENTORY = require('./inventory');
const __USERS = require('./users');
const __QUOTES = require('./quotes');
const __TIMESHEET = require('./timesheet');
...
module.exports = (AroFlo) => ({
	...
	quotes: __QUOTES(AroFlo),
	
	timesheet: __TIMESHEET(AroFlo),
