...
module.exports = (AroFlo) => ({
	/**
	 * List Client Custom Field Templates.
	 * 
	 * Returns details about a collection of Client Custom Field Templates.
	 */
	list: async (query = {}) => {
		...
		return AroFlo.httpRequest.get(`/templates/clients/customfields?` + urlSearchParams.join("&"), {});
	}
});